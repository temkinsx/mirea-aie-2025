...
def report(
    ...
    title: str = typer.Option("EDA-отчёт", help="Заголовок отчёта (первая строка Markdown)."),
) -> None:
    """
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        f.write(f"- Есть полностью пустые колонки: **{quality_flags['has_all_missing_columns']}**\n\n")
